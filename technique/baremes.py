...
baremes = {
    ...
    "apm": lambda p: p.communes.strasbourg.periscolaire_maternelle.bareme_journee,
    "apm_1_2": lambda p: p.communes.strasbourg.periscolaire_maternelle.bareme_matin_ou_soir,
    ...
    "ccs_eveil_tri_tp": lambda p: p.communes.strasbourg.centre_choregraphique.eveil_trimestre.TP,
    "ccs_eveil_tri_ra": lambda p: p.communes.strasbourg.centre_choregraphique.eveil_trimestre.RA,
    "ccs_eveil_tri_rb": lambda p: p.communes.strasbourg.centre_choregraphique.eveil_trimestre.RB,
    ...
    "ccs_enf_1c_tri_tp": lambda p: p.communes.strasbourg.centre_choregraphique.enfant._1_cours_trimestre.TP,
    "ccs_enf_1c_tri_ra": lambda p: p.communes.strasbourg.centre_choregraphique.enfant._1_cours_trimestre.RA,
    "ccs_enf_1c_tri_rb": lambda p: p.communes.strasbourg.centre_choregraphique.enfant._1_cours_trimestre.RB,
    ...
    "ccs_enf_4c_tri_tp": lambda p: p.communes.strasbourg.centre_choregraphique.enfant._4_cours_trimestre.TP,
    "ccs_enf_4c_tri_ra": lambda p: p.communes.strasbourg.centre_choregraphique.enfant._4_cours_trimestre.RA,
    "ccs_enf_4c_tri_rb": lambda p: p.communes.strasbourg.centre_choregraphique.enfant._4_cours_trimestre.RB,
    "ccs_enf_extra": lambda p: p.communes.strasbourg.centre_choregraphique.enfant.extra_cours,
    "ccs_enf_stage_journee_tp": lambda p: p.communes.strasbourg.centre_choregraphique.enfant.stage_journee.TP,
    "ccs_enf_stage_journee_red": lambda p: p.communes.strasbourg.centre_choregraphique.enfant.stage_journee.RC,
    ...
    "ccs_adu_2c_tri_tp": lambda p: p.communes.strasbourg.centre_choregraphique.adulte._2_cours_trimestre.TP,
    "ccs_adu_2c_tri_ra": lambda p: p.communes.strasbourg.centre_choregraphique.adulte._2_cours_trimestre.RA,
    "ccs_adu_2c_tri_rb": lambda p: p.communes.strasbourg.centre_choregraphique.adulte._2_cours_trimestre.RB,
    ...
    "ccs_adu_stage_tp": lambda p: p.communes.strasbourg.centre_choregraphique.adulte.stage.TP,
    "ccs_adu_stage_red": lambda p: p.communes.strasbourg.centre_choregraphique.adulte.stage.RC,
    "ccs_adu_stage_semaine": lambda p: p.communes.strasbourg.centre_choregraphique.adulte.stage_semaine,
    "crr_autre_dominante": lambda p: p.communes.strasbourg.conservatoire.autre_dominante,
    "crr_classe_prepa": lambda p: p.communes.strasbourg.conservatoire.classe_prepa,
    ...
    "crr_specialisation": lambda p: p.communes.strasbourg.conservatoire.specialisation,
    ...
    "pat_ecole": lambda p: p.communes.strasbourg.patinoire.ecole_de_glace,
    ...
    "pis_activite": lambda p: p.communes.strasbourg.piscine.activite.unitaire,
    "pis_activite_10": lambda p: p.communes.strasbourg.piscine.activite._10,
    "pis_aquabike": lambda p: p.communes.strasbourg.piscine.aquabike.unitaire,
    "pis_aquabike_cycle": lambda p: p.communes.strasbourg.piscine.aquabike.cycle,
}
